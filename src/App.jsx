  ...
  return (
    <>
      <div className="relative w-full h-screen overflow-hidden bg-opacity-100" onMouseMove={handleMouseMove}>
        <div className={`pointer-events-none absolute w-[3rem] h-[3rem] rounded-full ${(score < 3 && timer > 0) && "shadow-[0_0_0_9999px_rgba(0,0,0,1)]"} ${mode === 0 ? "bg-black" : "bg-transparent"} z-20`} style={{ top: cursorPosition.y - 25, left: cursorPosition.x - 25, }} />
